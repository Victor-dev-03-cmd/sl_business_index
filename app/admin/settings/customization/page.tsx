    ...
    <div className="space-y-10 animate-in fade-in duration-500 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-6 border-b border-gray-100 gap-4">
        <div>
          <h1 className="text-xl md:text-2xl font-normal text-gray-900 flex items-center gap-3">
            <Wrench className="h-6 w-6 text-brand-blue shrink-0" /> Advanced
            Customization
          </h1>
          <p className="text-sm text-gray-500 mt-1">
            Inject custom CSS and JavaScript to override platform defaults.
          </p>
        </div>
        <button
          onClick={handleSave}
      ...
      <div className="bg-amber-50 border border-amber-200 p-4 rounded-xl flex gap-4 items-start">
        ...
        <div>
          ...
          <p className="text-xs text-amber-700 font-normal mt-1">
            Adding custom scripts or styles can break the platform UI. Ensure
            your code is thoroughly tested before saving.
          </p>
        </div>
      </div>
