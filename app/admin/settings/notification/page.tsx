    ...
    <div className="space-y-10 animate-in fade-in duration-500 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-6 border-b border-gray-100 gap-4">
        <div>
          <h1 className="text-xl md:text-2xl font-normal text-gray-900 flex items-center gap-3">
            <Bell className="h-6 w-6 text-brand-blue shrink-0" /> Notification
            Settings
          </h1>
          <p className="text-sm text-gray-500 mt-1">
            Manage global email, push alerts, and administrative routing.
          </p>
        </div>
        <button
          onClick={handleSave}
      ...
      <div className="grid gap-8">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 font-normal">
                    Send automated emails for registrations, leads, and status
                    changes.
                  </p>
                </div>
              </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 md:p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 font-normal">
                    Enable real-time browser notifications for critical system
                    events.
                  </p>
                </div>
              </div>
        ...
        <section className="space-y-6">
          ...
          <div className="bg-gray-50/30 p-4 md:p-6 rounded-xl border border-gray-100 space-y-4">
            <div className="space-y-2">
              ...
              <p className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">
                All system alerts and backup logs will be sent to this address.
              </p>
            </div>
          </div>
        </section>
