...
export default function AdminBillingPage() {
  ...
  return (
    <div className="min-h-full bg-gray-50/30 transition-colors">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-6 md:mb-12 gap-4 md:gap-6">
          <div>
            ...
            <p className="text-base text-gray-500 mt-2">
              Manage plans, revenue, and platform-wide announcements.
            </p>
          </div>

          <div className="flex overflow-x-auto gap-1 p-1 bg-gray-100 rounded-xl border border-gray-200">
            {[
              ...
              <button
                ...
                className={`whitespace-nowrap shrink-0 flex items-center gap-2 px-4 sm:px-6 py-2.5 rounded-lg text-sm font-bold transition-all ${
                  activeTab === tab.id
          ...
          <div className="space-y-12">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <StatCard
                ...
                value={`LKR ${(totalRevenue / (invoices.length || 1)).toLocaleString()}`}
                icon={CreditCard}
                color="amber"
              />
              <StatCard
                title="Monthly Recurring"
                value={`LKR ${(activeSubs * 2500).toLocaleString()}`}
                icon={DollarSign}
                color="purple"
              />
            </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-10">
              <div className="xl:col-span-2 bg-white rounded-[6px] border border-gray-300 shadow-xl overflow-hidden">
                <div className="p-4 sm:p-6 border-b border-gray-300 flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between">
                  ...
                  <div className="relative w-full sm:w-64">
                    ...
                    <input
                      ...
                      className="w-full pl-9 pr-4 py-2 bg-gray-50 border border-gray-300 rounded-[6px] text-xs outline-none"
                    />
                  </div>
                </div>
                    ...
                    <tbody className="divide-y divide-gray-100">
                      {subscriptions.map((sub) => (
                        ...
                        >
                          ...
                          <td className="px-8 py-5">
                            <span className="text-xs font-bold text-brand-dark px-2 py-1 bg-gray-100 rounded-md uppercase tracking-tighter">
                              {sub.plan_name}
                            </span>
                          </td>
                          <td className="px-8 py-5">
              ...
              <div className="bg-white rounded-[6px] border border-gray-300 shadow-xl overflow-hidden">
                ...
                <div className="divide-y divide-gray-100">
                  {invoices.slice(0, 8).map((inv) => (
                    <div
                      key={inv.id}
                      className="p-5 hover:bg-gray-50 transition-all flex justify-between items-center group"
                    >
                      <div>
                        <p className="text-[10px] font-bold text-brand-blue uppercase tracking-widest mb-1">
                          #{inv.id.slice(0, 8)}
                        </p>
                      ...
                      <div className="text-right">
                        ...
                        <button
                          ...
                          className="text-[10px] font-bold text-brand-dark hover:text-brand-blue flex items-center gap-1 ml-auto"
                        >
                ...
                : plans.map((plan) => (
                    ...
                    >
                      ...
                      <div className="mb-8 mt-4">
                        <h4 className="text-2xl font-normal text-gray-900">
                          {plan.name}
                        </h4>
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Post notifications that appear as popups/banners for all
                  users.
                </p>
              </div>
              <button
                onClick={() => setShowAnnouncementDialog(true)}
                className="flex items-center gap-2 bg-brand-gold text-white px-6 py-3 rounded-xl font-bold text-sm hover:bg-brand-gold-light transition-all shadow-lg self-start sm:self-auto"
              >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {announcementsLoading
                ...
                : announcements.map((ann) => (
                    <div
                      key={ann.id}
                      className="bg-white rounded-2xl border border-gray-300 p-6 flex gap-6 group hover:border-brand-gold transition-all shadow-sm"
                    >
                      <div
          ...
          {selectedInvoice && (
            <div className="space-y-6">
              <div className="text-center pb-6 border-b border-gray-100">
                ...
                <DialogDescription className="text-sm text-gray-500 uppercase tracking-widest">
              ...
              <div className="space-y-4">
                ...
                <InfoRow
                  label="Date"
                  value={new Date(selectedInvoice.created_at).toLocaleString()}
                />
                <InfoRow
                  label="Status"
      ...
      >
        <DialogContent className="w-[95vw] max-w-2xl bg-white border-gray-300 p-6 sm:p-8 overflow-y-auto max-h-[90dvh]">
          <div className="space-y-6">
            <div>
              ...
              <DialogDescription className="text-sm text-gray-500">
                Define pricing and advanced feature limits.
              </DialogDescription>
            </div>
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setPlanForm({
                      ...planForm,
                      max_listings: parseInt(e.target.value),
                    })
                  }
                  className="w-full px-4 py-2 border border-gray-300 rounded-[6px] text-sm outline-none focus:border-brand-blue"
                />
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setPlanForm({
                      ...planForm,
                      price_monthly: parseInt(e.target.value),
                    })
                  }
                  className="w-full px-4 py-2 border border-gray-300 rounded-[6px] text-sm outline-none focus:border-brand-blue"
                />
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setPlanForm({
                      ...planForm,
                      price_yearly: parseInt(e.target.value),
                    })
                  }
                  className="w-full px-4 py-2 border border-gray-300 rounded-[6px] text-sm outline-none focus:border-brand-blue"
                />
        ...
        <DialogContent className="w-[95vw] max-w-md bg-white border-gray-300 p-6 sm:p-8 max-h-[90dvh] overflow-y-auto">
          <div className="space-y-6">
            <div>
              ...
              <DialogDescription className="text-sm text-gray-500">
                Notify users immediately with a popup.
              </DialogDescription>
            </div>
  ...
  return (
    <div className="bg-white p-6 rounded-[6px] border border-gray-300 shadow-sm hover:shadow-md transition-shadow">
      <div className="flex items-center justify-between mb-4">
        ...
        {trend && (
          <span
            className={`text-[10px] font-bold ${trend.startsWith("+") ? "text-emerald-600" : "text-red-600"} flex items-center gap-1`}
          >
            {trend.startsWith("+") ? (
...
function InfoRow({ label, value, isStatus }: any) {
  return (
    <div className="flex justify-between text-sm">
      ...
      <span
        className={`font-medium ${isStatus ? "text-emerald-600 font-bold uppercase text-xs" : "text-gray-900"}`}
      >
        {value}
      </span>
    </div>
