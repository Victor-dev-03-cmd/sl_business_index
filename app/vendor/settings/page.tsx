...
export default function SettingsPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Settings & Optimization</h1>
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1 space-y-6">
          ...
          {/* Profile Settings */}
          {activeTab === 'profile' && (
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 md:p-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input type="text" defaultValue="John Doe" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none text-sm" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Email Address</label>
                  <input type="email" defaultValue="john@example.com" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none text-sm" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Phone Number</label>
                  <input type="tel" defaultValue="+94 77 123 4567" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none text-sm" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Job Title</label>
                  <input type="text" defaultValue="Owner" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none text-sm" />
                </div>
              </div>

              <div className="mt-8 pt-8 border-t border-gray-200 flex justify-end">
                <button className="px-6 py-2.5 bg-emerald-600 text-white rounded-lg text-sm font-medium hover:bg-emerald-700 transition-colors shadow-sm shadow-emerald-200 flex items-center gap-2">
          ...
          {activeTab === 'verification' && (
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 md:p-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="space-y-6">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Business Registration (BR) Document</label>
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 flex flex-col items-center justify-center text-gray-500 hover:border-emerald-500 hover:bg-emerald-50 transition-colors cursor-pointer">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">NIC / Passport (Owner)</label>
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 flex flex-col items-center justify-center text-gray-500 hover:border-emerald-500 hover:bg-emerald-50 transition-colors cursor-pointer">
                    <Upload size={24} className="mb-2" />
                    <p className="text-sm font-medium">Click to upload or drag and drop</p>
              ...
              <div className="mt-8 pt-8 border-t border-gray-200 flex justify-end">
                <button className="px-6 py-2.5 bg-emerald-600 text-white rounded-lg text-sm font-medium hover:bg-emerald-700 transition-colors shadow-sm shadow-emerald-200">
                  Submit for Review
                </button>
              </div>
            </div>
            ...
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 md:p-8">
                <h2 className="text-lg font-bold text-gray-900 mb-4 flex items-center gap-2">
                  <MapPin size={20} className="text-emerald-600" /> Service Radius
                </h2>
                ...
                <div className="mb-8 px-2">
                  <div className="flex justify-between mb-4">
                    ...
                    <span className="text-sm font-bold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded">{radius[0]} km</span>
                  </div>
                  <Slider 
                    defaultValue={[5]} 
                    max={50} 
                ...
                {/* Mock Map Preview */}
                <div className="h-48 bg-gray-100 rounded-lg border border-gray-200 flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="w-32 h-32 rounded-full bg-emerald-500/20 border-2 border-emerald-500 flex items-center justify-center relative z-10 animate-pulse">
              ...
              <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 md:p-8">
                <h2 className="text-lg font-bold text-gray-900 mb-4 flex items-center gap-2">
                  <Search size={20} className="text-blue-600" /> Local SEO Keywords
                </h2>
                ...
                <div className="relative mb-4">
                  <input 
                    ...
                    className="w-full pl-4 pr-12 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none text-sm"
                    value={newKeyword}
                ...
                <div className="flex flex-wrap gap-2">
                  {keywords.map((keyword) => (
                    <span key={keyword} className="inline-flex items-center gap-1 px-3 py-1.5 bg-gray-100 text-gray-700 rounded-full text-sm font-medium border border-gray-200 group hover:bg-gray-200 transition-colors">
                      {keyword}
                ...
                <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-100">
                  ...
                  <div className="flex gap-2">
                    {['Catering', 'Events', 'Party'].map(s => (
                      <button key={s} onClick={() => { if(!keywords.includes(s)) setKeywords([...keywords, s]) }} className="text-xs bg-white text-blue-600 px-2 py-1 rounded border border-blue-200 hover:border-blue-400 transition-colors">
                        + {s}
                      </button>
                    ))}
                  </div>
