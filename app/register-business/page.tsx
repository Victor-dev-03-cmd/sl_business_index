        ...
        <div className="max-w-2xl w-full bg-white p-10 md:p-16 border border-gray-300 shadow-2xl rounded-[6px] text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
                  ...
                  className="flex items-center justify-center gap-2 px-8 py-4 bg-brand-dark text-white rounded-[6px] text-sm font-medium hover:bg-brand-blue transition-all shadow-lg active:scale-95"
                >
                  <Home size={18} />
                  Go to Home
                </button>
